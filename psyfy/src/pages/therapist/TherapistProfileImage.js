...
class TherapistProfileImage extends React.Component{
  constructor(){
    super()
    this.state={
      selectedFile:null,
  ...
  render(){
    return (
      <div>
        <div id="therapist-card">
          <img alt="Profile image" src={this.state.image_src!=null?this.state.image_src:require("../../assets/images/profile_fill.png")}/>
